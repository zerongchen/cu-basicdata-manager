...
$(document).ready(function(){
  ...
  $("#target").delegate(".edit-link", "click", function(e){
	
		 var active_component = $(this).parent().parent();
		 var text = $(this).parent().siblings("label").text();
		 $(".ibox-content .draggable").each(function(){
			 
			 if($(this).children("label").text() !== text){
		 ...
		 active_component.popover("show");
		 //class="leipiplugins"
	    var leipiplugins = active_component.find(".intellectual-system"),plugins =$(leipiplugins).attr("intellectual-system");//leipiplugins="text"
	      //exec plugins
	      if(typeof(LPB.plugins[plugins]) =='function') {
	    	  LPB.plugins[plugins](active_component,leipiplugins);
	      }
